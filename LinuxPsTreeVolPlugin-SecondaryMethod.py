#This secondary method will use a different technique to lign up the sub procs.
...
orderproc = [[["System",4,0],["smss.exe",208,4]],[["crss.exe",344,234],["conhost",2246,344]],[["winit",332,288],["lsass",444,332],[["services.exe",123,123],[["svchost",123,313], ["rundll32",32,23]],["sppsvc",123,232],["taskhost",1144,428]]]]

print(orderproc[2][2][1])
...
for index in range(len(allprocs)):
 ...
 # print(a)
  ...
  for sublist in allprocs:
    if a in sublist:
      #print(allprocs.index(sublist), '-', sublist.index(a))
      (allprocs[allprocs.index(sublist)])
